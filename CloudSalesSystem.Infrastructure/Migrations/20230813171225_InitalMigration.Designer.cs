...
namespace CloudSalesSystem.Infrastructure.Migrations
{
    ...
    [Migration("20230813171225_InitalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudSalesSystem.Domain.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CloudSalesSystem.Domain.SubscriptionItems.SubscriptionItem", b =>
                {
                    ...
                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_subscription_items_product_id");
            ...
            modelBuilder.Entity("CloudSalesSystem.Domain.SubscriptionItems.SubscriptionItem", b =>
                {
                    b.HasOne("CloudSalesSystem.Domain.Products.Product", "Product")
                        .WithMany("SubscriptionItems")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_items_products_product_id");
